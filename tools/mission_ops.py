...
def update_mission(step_description: str, status: str = "completed") -> str:
    ...
    try:
        ...
        return (
            f"Mission updated: Step {mission_data['current_step']} marked as {status}."
        )
    except Exception as e:
...
def read_mission() -> str:
    ...
    try:
        ...
        if mission_data["steps_completed"]:
            summary += (
                "**Last Action**: " + mission_data["steps_completed"][-1]["description"]
            )
