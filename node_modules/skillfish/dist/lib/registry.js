 ...
 */
export async function submitSkillsToRegistry(skills) {
    ...
    for (const [repoKey, repoSkills] of repoMap) {
        ...
        try {
            const res = await fetchWithRetry(REGISTRY_API_URL, {
                method: 'POST',
                headers: {
 ...
 */
export async function searchSkillsInRegistry(query, limit = 5) {
    try {
