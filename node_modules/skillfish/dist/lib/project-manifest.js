 ...
 */
export function getProjectManifestPath(global) {
 ...
 */
export function readProjectManifest(manifestPath) {
 ...
 */
export function writeProjectManifest(manifestPath, manifest) {
 ...
 */
export function deriveSkillDirName(entry) {
    let name;
    if (entry.path) {
 ...
 */
export function formatSkillEntry(entry) {
 ...
 */
export function parseAllEntries(manifest) {
    const entries = [];
    const errors = [];
 ...
 */
function isValidProjectManifest(data) {
